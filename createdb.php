...
// mysql_query("DROP TABLE admin,affiliates,cart,cartoptions,clientlogin,countries,coupons,cpnassign,optiongroup,options,orders,payprovider,postalzones,pricebreaks,prodoptions,products,sections,states,tmplogin,topsections,uspsmethods,zonecharges") or print_sql_error();
...
$sSQL .= "cartQuantity INT,";
$sSQL .= "cartOrderID INT,";
...
$sSQL = "CREATE TABLE clientlogin (clientUser VARCHAR(50) PRIMARY KEY,";
$sSQL .= "clientPW VARCHAR(50) NULL,";
$sSQL .= "clientLoginLevel TINYINT DEFAULT 0,";
$sSQL .= "clientPercentDiscount DOUBLE DEFAULT 0,";
$sSQL .= "clientActions INT DEFAULT 0,";
$sSQL .= "clientEmail VARCHAR(255) NULL)";
...
$sSQL .= "INDEX (ssdenyip), UNIQUE (ssdenyip))";
...
$sSQL .= "ordExtra3 VARCHAR(255) NULL,";
...
mysql_query("INSERT INTO countries (countryID,countryName,countryEnabled,countryTax,countryOrder,countryZone,countryLCID,countryCurrency,countryCode) VALUES (85,'Hong Kong',1,0,0,4,'','HKD','HK')");
mysql_query("INSERT INTO countries (countryID,countryName,countryEnabled,countryTax,countryOrder,countryZone,countryLCID,countryCurrency,countryCode) VALUES (86,'Hungary',0,0,0,4,'','HUF','HU')");
