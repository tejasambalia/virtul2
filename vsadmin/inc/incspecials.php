...
/* ]]> */
	...
	<input type="hidden" name="prod" value="<?php print $giftcertificateid?>" />
      <table class="cobtbl" border="0" cellspacing="1" cellpadding="3" width="90%" align="center">
        <tr> 
          <td class="cobhl cobhdr" height="34" align="center" colspan="2"><strong><?php print $GLOBALS['xxGCPurc']?></strong></td>
        </tr>
<?php	if(getpost('posted')=='1'){ ?>
        <tr>
          <td class="cobhl" height="34" align="center" colspan="2"><span style="color:#FF0000;font-weight:bold"><?php print $GLOBALS['xxAmtNov']?></span></td>
        </tr>
<?php	} ?>
		<tr> 
          <td class="cobhl" height="34" align="right"><strong><label for="amount"><?php print $GLOBALS['xxAmount']?></label>:</strong></td>
		  <td class="cobll" height="34" align="left"><input type="text" name="amount" id="amount" size="4" maxlength="10" value="<?php print htmlspecials(getpost('amount'))?>" /></td>
        </tr>
		<tr> 
          <td class="cobhl" height="34" align="right"><strong><label for="toname"><?php print $GLOBALS['xxTo']?></label>:</strong></td>
		  <td class="cobll" height="34" align="left"><input type="text" name="toname" id="toname" size="25" maxlength="50" value="<?php print htmlspecials(getpost('toname'))?>" /></td>
        </tr>
		<tr> 
          <td class="cobhl" height="34" align="right"><strong><label for="fromname"><?php print $GLOBALS['xxFrom']?></label>:</strong></td>
		  <td class="cobll" height="34" align="left"><input type="text" name="fromname" id="fromname" size="25" maxlength="50" value="<?php print htmlspecials(getpost('fromname'))?>" /></td>
        </tr>
		<tr> 
          <td class="cobhl" height="34" align="right"><strong><label for="toemail"><?php print $GLOBALS['xxReEmai']?></label>:</strong></td>
		  <td class="cobll" height="34" align="left"><input type="text" name="toemail" id="toemail" size="25" maxlength="50" value="<?php print htmlspecials(getpost('toemail'))?>" /></td>
        </tr>
		<tr> 
          <td class="cobhl" height="34" align="right"><strong><label for="toemail2"><?php print $GLOBALS['xxCReEma']?></label>:</strong></td>
		  <td class="cobll" height="34" align="left"><input type="text" name="toemail2" id="toemail2" size="25" maxlength="50" value="<?php print htmlspecials(getpost('toemail2'))?>" /></td>
        </tr>
		<tr> 
          <td class="cobhl" height="34" align="right"><strong><label for="gcmessage"><?php print $GLOBALS['xxMessag']?></label>:</strong></td>
		  <td class="cobll" height="34" align="left"><textarea name="gcmessage" id="gcmessage" cols="35" rows="4"><?php print htmlspecials(getpost('gcmessage'))?></textarea></td>
        </tr>
		<tr> 
          <td class="cobll" height="34" colspan="2" align="center"><?php print imageorsubmit(@$GLOBALS['imggcsubmit'],$GLOBALS['xxSubmt'],'gcsubmit')?></td>
        </tr>
      </table>
	</form>
<?php
...
<?php	} ?>
	...
	<input type="hidden" name="prod" value="<?php print $donationid?>" />
      <table class="cobtbl" border="0" cellspacing="1" cellpadding="3" width="90%" align="center">
        <tr> 
          <td class="cobhl cobhdr" height="34" align="center" colspan="2"><strong><?php print $GLOBALS['xxMakDon']?></strong></td>
        </tr>
<?php	if(getpost('posted')=='1'){ ?>
        <tr>
          <td class="cobhl" height="34" align="center" colspan="2"><span style="color:#FF0000;font-weight:bold"><?php print $GLOBALS['xxAmtNov']?></span></td>
...
<?php	} ?>
		<tr> 
          <td class="cobhl" height="34" align="right"><strong><?php print $redasterix?><label for="amount"><?php print $GLOBALS['xxAmount']?></label>:</strong></td>
		  <td class="cobll" height="34" align="left"><input type="text" name="amount" id="amount" size="6" maxlength="10" value="<?php print htmlspecials(getpost('amount'))?>" /></td>
        </tr>
		<tr> 
          <td class="cobhl" height="34" align="right"><strong><label for="fromname"><?php print $GLOBALS['xxFrom']?></label>:</strong></td>
		  <td class="cobll" height="34" align="left"><input type="text" name="fromname" id="fromname" size="25" maxlength="50" value="<?php print htmlspecials(getpost('fromname'))?>" /></td>
		...
		<tr> 
          <td class="cobll" height="34" colspan="2" align="center"><?php print imageorsubmit(@$GLOBALS['imgdonationsubmit'],$GLOBALS['xxSubmt'],'donationsubmit')?></td>
        </tr>
      </table>
<?php	if(! @$isincluded){ ?>
	</form>
