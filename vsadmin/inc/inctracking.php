		...
		<tr>
		  <td class="cobll" colspan="2">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
			  <tr>
				<td width="40"><img src="images/canadapost.gif" alt="CanadaPost" /></td><td align="center">&nbsp;<br /><span style="font-size:18px;font-family:Verdana;font-weight:bold">Canada Post<small>&reg;</small> Tracking Tool</span><br />&nbsp;</td><td width="40">&nbsp;</td>
			  </tr>
			</table>
		  </td>
		</tr>
...
?>
			  <tr>
			    <td class="cobhl" width="50%" align="right">Please enter your Canada Post Tracking Number : </td>
				<td class="cobll" width="50%"><input type="text" size="30" name="trackno" value="<?php print htmlspecials(getrequest('trackno'))?>" /></td>
			  </tr>
			  <tr>
			    <td class="cobhl" width="50%" align="right">Show Activity : </td>
				<td class="cobll" width="50%"><select name="activity" size="1"><option value="LAST">Show Last Activity Only</option><option value="ALL"<?php if(getpost('activity')=="ALL") print ' selected="selected"'?>>Show All Activity</option></select></td>
			  </tr>
			  <tr>
			    <td class="cobll" colspan="2" align="center"><?php print imageorsubmit(@$imgtrackpackage,'Track Package','trackpackage')?></td>
			  </tr>
			</table>
	</form>
<br />
...
?>
			  ...
			  <tr>
			    <td class="cobll" colspan="2" align="center"><?php print imageorbutton(@$imgviewlicense,'View License','viewlicense','viewlicense()',TRUE).' '.imageorbutton(@$imgtrackpackage,'Track Package','trackpackage','checkaccept()',TRUE)?></td>
			  </tr>
			  <tr>
				<td class="cobll" width="100%" height="30" colspan="2" align="center" valign="middle"><span style="font-size:10px"><input type="checkbox" name="agreeconds" value="ON" <?php if(getpost('agreeconds')=="ON") print "checked"?> /> By selecting this box and the "Track Package" button, I agree to these <a class="ectlink" href="javascript:viewlicense();"><strong>Terms and Conditions</strong></a>.</span></td>
			  </tr>
			</table>
	  <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
        <tr>
          <td width="100%" align="center"><p>&nbsp;<br /><span style="font-size:10px"><?php print str_replace("'","\'",$GLOBALS['xxUPStm'])?></span></p></td>
		</tr>
	  </table>
	</form>
<br />
...
?>
			  ...
			  <tr>
			    <td class="cobhl" width="50%" align="right">Show Activity : </td>
				<td class="cobll" width="50%"><select name="activity" size="1"><option value="LAST">Show Last Activity Only</option><option value="ALL"<?php if(getpost('activity')=="ALL" || getpost('activity')=='') print ' selected="selected"'?>>Show All Activity</option></select></td>
			  </tr>
			  <tr>
			    <td class="cobll" colspan="2" align="center"><?php print imageorsubmit(@$imgtrackpackage,'Track Package','trackpackage')?></td>
			  </tr>
...
"</soapenv:Envelope>";
	...
	if($success){
	  ...
	  <tr>
		<td class="cobhl" width="30%"><strong>Service Description</strong> </td>
		<td class="cobll"><?php print str_replace('_',' ',$serviceDesc)?></td>
	  </tr>
	<?php	}
			if(trim($packagecount)!=''){ ?>
	  <tr>
...
<?php	if(@$shipType==4 || $alternateratesups || strpos(strtolower(@$trackingcarriers), 'ups')!==FALSE){ ?>
		<tr>
		  ...
		  <td class="cobll" width="50%"><?php print imageorsubmit(@$imgtrackinggo,$GLOBALS['xxGo'].'" onclick="document.getElementById(\'carrier\').value=\'ups\'','trackinggo')?></td>
		</tr>
<?php	}
		if($shipType==3 || $alternateratesusps || strpos(strtolower(@$trackingcarriers), 'usps')!==FALSE){ ?>
		<tr>
		  <td class="cobhl" width="50%" align="right">Products shipped via USPS : </td>
		  <td class="cobll" width="50%"><?php print imageorsubmit(@$imgtrackinggo,$GLOBALS['xxGo'].'" onclick="document.getElementById(\'carrier\').value=\'usps\'','trackinggo')?></td>
		</tr>
<?php	}
		if($shipType==7 || $shipType==8 || $alternateratesfedex || strpos(strtolower(@$trackingcarriers), 'fedex')!==FALSE){ ?>
		<tr>
		  <td class="cobhl" width="50%" align="right">Products shipped via FedEx : </td>
		  <td class="cobll" width="50%"><?php print imageorsubmit(@$imgtrackinggo,$GLOBALS['xxGo'].'" onclick="document.getElementById(\'carrier\').value=\'fedex\'','trackinggo')?></td>
		</tr>
<?php	} ?>
	  </table>
	</form>
