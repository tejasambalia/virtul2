...
<?php		} ?>
					...
					<tr>
					  ...
					  <td align="left" colspan="3">
						...
						<td>&nbsp;&nbsp;<?php if(! $doedit) print '<input type="submit" value="' . $yyUpdate . '" ' . ($alldata['ordPayProvider']==20 ? 'onclick="updategooglestatus(\'message\',' . getget('id') . ')" ' : '') . '/>'?></td>
						</tr></table>
					  </td>
					</tr>
...
function processdazzle(){
	...
	if(dazzletext==''){
		...
		ajaxobj.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		ajaxobj.setRequestHeader("Content-length", ('dazzletext='+dazzletext).length);
