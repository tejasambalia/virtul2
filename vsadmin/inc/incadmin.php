...
<tr><th>&nbsp;</th><th style="text-align:right;">No</th><th style="text-align:right;">Value</th><th style="text-align:right;">No</th><th style="text-align:right;">Value</th></tr>
<tr><td style="font-size:10px">&nbsp;</td><td colspan="2" style="text-align:center;font-size:10px">This Year</td><td colspan="2" style="text-align:center;font-size:10px">Last Year</td></tr>
<tr>
	<td style="text-align:right;width:20%"><?php print $thismonth?></td>
	<td style="text-align:right;" title="<?php print FormatEuroCurrency($thismonthorders[0]==0?0:$thismonthtotal[0]/$thismonthorders[0]);?>"><?php print $thismonthorders[0] . '</td><td style="text-align:right;">' . FormatEuroCurrency($thismonthtotal[0]);?></td>
	<td style="text-align:right;" title="<?php print FormatEuroCurrency($thismonthorders[1]==0?0:$thismonthtotal[1]/$thismonthorders[1]);?>"><?php print $thismonthorders[1] . '</td><td style="text-align:right;">' . FormatEuroCurrency($thismonthtotal[1]);?></td>
</tr>
<tr>
	<td style="text-align:right;width:20%"><?php print $lastmonth?></td>
	<td style="text-align:right;" title="<?php print FormatEuroCurrency($lastmonthorders[0]==0?0:$lastmonthtotal[0]/$lastmonthorders[0]);?>"><?php print $lastmonthorders[0] . '</td><td style="text-align:right;">' . FormatEuroCurrency($lastmonthtotal[0]);?></td>
	<td style="text-align:right;" title="<?php print FormatEuroCurrency($lastmonthorders[1]==0?0:$lastmonthtotal[1]/$lastmonthorders[1]);?>"><?php print $lastmonthorders[1] . '</td><td style="text-align:right;">' . FormatEuroCurrency($lastmonthtotal[1]);?></td>
</tr>
<tr>
	<td style="text-align:right;width:20%;white-space:nowrap"><?php print 'Jan 1 - Now'?></td>
	<td style="text-align:right;" title="<?php print FormatEuroCurrency($yearorders[0]==0?0:$yeartotal[0]/$yearorders[0]);?>"><?php print $yearorders[0] . '</td><td style="text-align:right;">' . FormatEuroCurrency($yeartotal[0]);?></td>
	<td style="text-align:right;" title="<?php print FormatEuroCurrency($yearorders[1]==0?0:$yeartotal[1]/$yearorders[1]);?>"><?php print $yearorders[1] . '</td><td style="text-align:right;">' . FormatEuroCurrency($yeartotal[1]);?></td>
</tr>
<tr>
	<td style="text-align:right;width:20%;white-space:nowrap"><?php print '12 Months'?></td>
	<td style="text-align:right;" title="<?php print FormatEuroCurrency($last12[0]==0?0:$last12total[0]/$last12[0]);?>"><?php print $last12[0] . '</td><td style="text-align:right;">' . FormatEuroCurrency($last12total[0]);?></td>
	<td style="text-align:right;" title="<?php print FormatEuroCurrency($last12[1]==0?0:$last12total[1]/$last12[1]);?>"><?php print $last12[1] . '</td><td style="text-align:right;">' . FormatEuroCurrency($last12total[1]);?></td>
</tr>
<tr>
	<td style="text-align:right;width:20%;white-space:nowrap"><?php print 'All Time'?></td>
	<td style="text-align:right;" title="<?php print FormatEuroCurrency($alltime==0?0:$alltimetotal/$alltime);?>"><?php print $alltime . '</td><td style="text-align:right;">' . FormatEuroCurrency($alltimetotal);?></td>
	<td colspan="2">&nbsp;</td>
</tr>
</table>
</div>
