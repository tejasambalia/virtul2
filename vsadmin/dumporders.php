...
if(@$_POST["act"]=="dumpaffiliate"){
	...
	if(strpos(@$detailpagelayout,'custom1')!==FALSE) $fieldlist.=',pCustom1';
	if(strpos(@$detailpagelayout,'custom2')!==FALSE) $fieldlist.=',pCustom2';
	if(strpos(@$detailpagelayout,'custom3')!==FALSE) $fieldlist.=',pCustom3';
