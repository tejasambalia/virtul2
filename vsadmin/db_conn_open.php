...
$db_username = "u197245873_virtu";  // Your database login username
$db_password = "XlIcabHoN1yQ";  // Your database login password
$db_name = "u197245873_virtu";      // The name of the database you wish to use
